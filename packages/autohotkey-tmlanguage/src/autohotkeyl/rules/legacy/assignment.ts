...
import { alt, capture, char, endAnchor, escapeOnigurumaTexts, group, groupMany0, inlineSpaces0, inlineSpaces1, lookahead, lookbehind, many1, negativeLookahead, ordalt, seq } from '../../../oniguruma';
