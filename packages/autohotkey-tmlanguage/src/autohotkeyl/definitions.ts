...
export const commandDefinitions: CommandDefinition[] = [
  ...
  command('FormatTime', [
    signature([ $output(), $(), $subcommandlike([ 'Time', 'ShortDate', 'LongDate', 'YearMonth', 'YDay', 'YDay0', 'WDay', 'YWeek' ]) ]),
  ...
  command('Gui', [
    ...
    signature([ $guisubcommand('Font'), $([ colorOption('C'), floatOption('S', 'W', 'Q') ]), $fontName() ]),
  ...
  command('ImageSearch', signature([ $output(), $output(), $expression(), $expression(), $expression(), $expression(), $([ stringOption('HICON:', 'HBITMAP:'), floatOption('*Icon', '*', '*Trans', '*w', '*h') ]) ])),
  ...
  command('Menu', [
    ...
    signature([ $subcommand('Tray'), $subcommand([ 'Tip' ]), $() ]),
    signature([ $subcommand('Tray'), $subcommand([ 'Click' ]), $shouldInteger() ]),
  ...
  command('RegWrite', signature([ $shouldKeyword([ keywordOption('REG_SZ', 'REG_EXPAND_SZ', 'REG_MULTI_SZ', 'REG_DWORD', 'REG_BINARY') ]), $regkey(), $(), $withNumber(), $withNumber() ])),
  ...
  command('Sort', signature([ $input(), $([ keywordOption('C', 'CL', 'N', 'R', 'Random', 'U', 'Z', '\\'), floatOption('D', 'P'), identifierOption('F') ]) ])),
  ...
  command('StringGetPos', signature([ $output(), $input(), $(), $shouldKeyword([ floatOption('L', 'R') ]), $expression() ]), CommandFlag.Deprecated),
