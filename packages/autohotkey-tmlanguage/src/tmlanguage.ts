...
export const enum Repository {
  ...
  DereferenceInCommandArgument = '$DereferenceInCommandArgument',
  ...
  CommandArgumentColor = '$CommandArgumentColor',
  ...
  CommandArgumentMenuItemName = '$MenuItemNameCommandArgument',
