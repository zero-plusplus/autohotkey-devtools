...
import { alt, capture, char, endAnchor, escapeOnigurumaTexts, group, ignoreCase, inlineSpace, inlineSpaces0, inlineSpaces1, lookahead, lookbehind, negativeLookahead, ordalt, seq } from '../../../oniguruma';
