    ...
    test(
      ...
      async() => {
        ...
        expect(actual).toStrictEqual([
          ...
          { text: 'b', scopes: [ name(RuleName.SingleString), name(RuleName.IllegalSingleLineStringContent) ] },
          { text: '\r\n', scopes: [ name(RuleName.SingleString), name(RuleName.IllegalStringNewLine) ] },
          { text: 'c', scopes: [ name(RuleName.SingleString), name(RuleName.IllegalSingleLineStringContent) ] },
          { text: '\n', scopes: [ name(RuleName.SingleString), name(RuleName.IllegalStringNewLine) ] },
          { text: `'`, scopes: [ name(RuleName.SingleString), name(RuleName.StringEnd) ] },
        ]);
      },
