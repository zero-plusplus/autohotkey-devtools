...
export function createFileGetTimeExpectedDataList(scopeName: ScopeName): ExpectedTestData[] {
  const commandName = 'FileGetTime';
  ...
  return [
    ...
    ...$shouldKeyword(scopeName, [ 'M', 'C', 'A' ], { name: commandName, index: 2, isLastParameter: true }),
  ];
}
