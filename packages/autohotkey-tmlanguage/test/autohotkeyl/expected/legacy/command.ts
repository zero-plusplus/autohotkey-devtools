...
import {
  $, $blank, $rest, $shouldInteger, CommandFlag, control, expression, fileAttributes, flagedGuiControlOptions, guiControlOptions,
  guiOptions, keywordOnly, onOff, output, sendKeys, winTitle,
} from '../../../../src/definition';
import {
