...
import {
  $, $blank, $control, $expression, $fileAttributes, $guiOptions, $input, $output, $rest, $shouldInteger, $shouldKeyword, $winTitle,
  CommandFlag, flagedGuiControlOptions, guiControlOptions, onOff, sendKeys,
} from '../../../../src/definition';
import {
