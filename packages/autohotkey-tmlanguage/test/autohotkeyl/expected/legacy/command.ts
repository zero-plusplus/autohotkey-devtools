...
import {
  $, $blank, $expression, $fileAttributes, $guiOptions, $input, $output, $rest, $shouldInteger, $shouldKeyword, CommandFlag, control,
  flagedGuiControlOptions, guiControlOptions, onOff, sendKeys, winTitle,
} from '../../../../src/definition';
import {
