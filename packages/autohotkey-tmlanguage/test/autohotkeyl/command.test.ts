  ...
  test.each([
    ...
    [
      'AutoTrim, %true%', [
        ...
        { text: ',', scopes: name(Repository.Command, Repository.CommandArgument, RuleName.Comma) },
        { text: ' ' },
        { text: '%', scopes: name(Repository.Command, Repository.CommandArgument, Repository.Dereference, RuleName.PercentBegin) },
        { text: 'true', scopes: name(Repository.Command, Repository.CommandArgument, Repository.Dereference, RuleName.BuiltInVariable) },
        { text: '%', scopes: name(Repository.Command, Repository.CommandArgument, Repository.Dereference, RuleName.PercentEnd) },
      ],
    ],
    [
      'AutoTrim, % true', [
        ...
        { text: ',', scopes: name(Repository.Command, Repository.CommandArgument, RuleName.Comma) },
        { text: ' ' },
        { text: '%', scopes: name(Repository.Command, Repository.CommandArgument, Repository.PercentExpression, RuleName.PercentBegin) },
        { text: ' ' },
        { text: 'true', scopes: name(Repository.Command, Repository.CommandArgument, Repository.PercentExpression, RuleName.BuiltInVariable) },
      ],
    ],
    [
      dedent`
    ...
    [
      ...
      `, [
        ...
        { text: '%', scopes: name(Repository.Command, Repository.CommandArgument, Repository.PercentExpression, RuleName.PercentBegin) },
        { text: ' ' },
        { text: 'continuation', scopes: name(Repository.Command, Repository.CommandArgument, Repository.PercentExpression, RuleName.Variable) },
        { text: '\n' },
        { text: '  ' },
