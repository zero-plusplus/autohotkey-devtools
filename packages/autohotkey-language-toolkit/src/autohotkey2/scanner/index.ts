import { spec as spec_ahkl } from '../../autohotkeyl/scanner';
import { scanNewLineToken } from '../../autohotkeyl/scanner/rules';
...
export const spec: LexicalSpec = {
  tokenTable,
  keywordTable: {},
  leadingTrivias: spec_ahkl.leadingTrivias,
  trailingTrivias: spec_ahkl.trailingTrivias,
};
